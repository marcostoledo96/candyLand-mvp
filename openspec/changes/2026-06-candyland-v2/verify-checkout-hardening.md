...
|---|---|---|
| `npm test` | PASS — 69/69 | `sha256:6e5712982c104fec120b356e88678cca12ec317fe5560626ae717ccf1b94b978` |
| `npm run test:checkout-hardening` | PASS — 5/5 | `sha256:de8fcd9babe6089b71ca8f10e534b0b5b9516c0fcbe1446c3a058905f83f7aab` |
| `npm run assert:checkout-hardening` | PASS | `sha256:259ba2cb86268c1248e416b9aa6c1b1cab4f4a55b99ceb645a5ae9a26e8bc29e` |
| `npm run test:checkout-differential` | PASS — baseline fails 10 changed contracts; candidate passes 11/11 | `sha256:40bf489b5546443864cf86efe800517a6eab1fa54710a0a7a645264ac2fff466` |
...
| Clean checkout Playwright | PASS — 15 scenarios, 8 observed requests, 0 unexpected errors | MCP runtime |
...
| Current GREEN | ✅ 69 frontend tests, 12 backend files, Prisma/static/differential/build/lint and Playwright pass |
...
**Test layers**: 5 frontend unit cases, 2 differential/static cases, 15 browser scenarios, and 12 backend test files including stubbed HTTP/transaction concurrency. Real PostgreSQL was intentionally not used.
...
| Replay semantics — changed cart | Introduced with idempotency, deterministic | Reusing a key after the same cart ID's contents changed replays the old order and then clears the current cart identity. |
...
| Metric | Value |
|---|---:|
| Exact post-verify additions | 1,469 |
| Exact post-verify deletions | 489 |
| Exact post-verify total | 1,958 / 3,000 |
| Archive refresh allowance | ≤80 lines |
| Tracked/untracked paths | 18 modified + 10 untracked = 28 |
| Headroom | 1,042 lines |
